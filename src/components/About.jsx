        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="transition-all duration-700 animate-slideIn opacity-100 delay-100">
              ...
              <img className="w-full h-auto object-cover transition-transform duration-700 group-hover:scale-105" src={about}alt="" />
            ...
            <div className="flex flex-col gap-6 md:text-left text-center group">
              <p className="text-lg leading-relaxed text-[#71717b] mb-6 relative md:pl-4 md:border-l-[3px] border-[#3b82f6] transition-all duration-500 animate-fadeInUp opacity-100 delay-200">
              ...
              <div className="transition-all duration-500 animate-fadeInUp opacity-100 delay-300">
                <div className="text-[#71717b] leading-7 p-6 rounded-lg relative bg-[#374151]/80 group mb-6 group hover:bg-muted/90 transition-colors duration-300 hover:shadow-md">
                <span className="absolute top-0 left-4 text-5xl leading-none text-[#3b82f6]/40 font-serif transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12 group-hover:text-[#3b82f6]/60">"</span>
              <p className="relative transition-all duration-300 group-hover:translate-x-1">We take pride in our attention to detail and personalized service, ensuring each client leaves looking and feeling their best. Our skilled barbers combine traditional techniques with modern trends to create custom styles that suit each individual's personality and lifestyle.</p>
              <div className="absolute bottom-4 left-6 right-6 h-[1px] bg-[#3b82f6]/0 transition-all duration-500 group-hover:bg-[#3b82f6]/20"></div>
              </div>
              </div>
              </div>
          </div>
